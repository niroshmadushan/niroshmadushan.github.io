document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchCurrentStock() {
        try {
            const response = await fetch('get_current_stockv.php');
    ...
    document.getElementById('openGRNModal').onclick = async () => {
        ...
        try {
            const response = await fetch('get_productsv.php');
            const data = await response.json();
            if (data.success) {
    ...
    document.getElementById('openGONModal').onclick = async () => {
        ...
        try {
            const response = await fetch('get_productv.php');
            const data = await response.json();
            if (data.success) {
                productList = data.products;
    ...
    document.getElementById('addGRNBtn').onclick = async () => {
        ...
        if (product && quantity && unitPrice) {
            try {
                const response = await fetch('add_grnv.php', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
    ...
    document.getElementById('addGONBtn').onclick = async () => {
        ...
        if (product && quantity) {
            try {
                const response = await fetch('add_gonv.php', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
    ...
    document.getElementById('printReportBtn').onclick = async () => {
        try {
            const response = await fetch('get_report_datav.php', {
                method: 'GET'
            });
            const data = await response.json();
            if (data.success) {

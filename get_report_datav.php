...
$grnEntries = readAllData('grnv.txt', 5); // Assuming date is the 6th column (index 5)
$gonEntries = readAllData('gonv.txt', 5); // Assuming date is the 5th column (index 4)

// Read current stock without unitPrice (marked with true for the last argument)
$currentStock = readAllData('currentstockv.txt', 4, true); // Assuming date is the 5th column (index 4)
